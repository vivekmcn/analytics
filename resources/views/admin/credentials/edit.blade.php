              ...
              <div class="col-6">
                <!-- Horizontal Form -->
                  <div class="card card-info">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form class="form-horizontal" method="post" action="{{ route('admin.credentials.update') }}">
                      @csrf
                      ...
                      <div class="card-body">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            <select class="form-control" name="credential_type_id">
                              ...
                              <option value="{{ $typeid }}" {{ ($typeid == $credential->credential_type_id)?"selected":"" }}>{{ $type }}</option>
                              @endforeach
                            </select>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="credential" placeholder="Credential" value="{{ old('credential')?old('credential'):$credential->credential }}" name="credential">
                           @error('credential')
                                <span class="invalid-feedback" role="alert" style="display: block;">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="cred_key" placeholder="Credential Key" value="{{ old('cred_key')?old('cred_key'):$credential->cred_key }}" name="cred_key">
                           @error('cred_key')
                                <span class="invalid-feedback" role="alert" style="display: block;">
                                    <strong>{{ $message }}</strong>
                                </span>
                          ...
                          <div class="col-sm-10">
                            <div class="form-group">
                              <div class="form-check">
                                <input type="radio" name="status" value="1" class="form-check-input" {{ $credential->status==1?"checked":"" }} />
                                <label class="form-check-label">Active</label>
                              </div>
                              <div class="form-check">
                                <input type="radio" name="status" value="0" class="form-check-input" {{ $credential->status==0?"checked":"" }} />
