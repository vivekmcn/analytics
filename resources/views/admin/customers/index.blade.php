...
@section('content')
                ...
                <div class="card">
                  <div class="card-header d-flex p-0">
                    ...
                    <ul class="nav nav-pills ml-auto p-2">
                      <li class="nav-item">
                        <a href="{{ route('admin.customers.add') }}" class="nav-link active">Create</a>
                      </li>
                    </ul>
                  </div>
                  <!-- /.card-header -->
  ...
  $(function () {
    ...
    var view    =   "{{ route('admin.customers.view', ['id' => '__id']) }}";
    var edit = "{{ route('admin.customers.edit',['id'=>'__id']) }}";
    var deletelink = "{{ route('admin.customers.delete',['id'=>'__id']) }}";
    var slno = 0;
    $('#datatable').DataTable({
      "pageLength": 10,
          "responsive": true,
          ...
          "ajax": {
              "url": "{{ route('admin.customers.paginate') }}",
              "type": "post",
              "data": function (data) {
